...
The `SubTurn` mechanism is a core feature in Heron that allows tools to spawn isolated, nested agent loops to handle complex sub-tasks.
...
SubTurns emit specific events to the Heron `EventBus` for observability and debugging:
