...
5. Fill in the App ID and App Secret in the Heron configuration file
6. Run `heron gateway` to start the service
7. Search for the bot name in Feishu and start a conversation

> Heron connects to Feishu using WebSocket/SDK mode — no public callback address or Webhook URL is required.
>
