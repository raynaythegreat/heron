...
Discord est une application gratuite de chat vocal, vidéo et textuel conçue pour les communautés. Heron se connecte aux serveurs Discord via l'API Bot Discord, avec prise en charge de la réception et de l'envoi de messages.
