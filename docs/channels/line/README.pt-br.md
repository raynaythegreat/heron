...
O Heron suporta o LINE por meio da LINE Messaging API com callbacks de webhook.
...
3. Configure o webhook:
   ...
   - O Heron usa um servidor HTTP Gateway compartilhado para receber callbacks de webhook de todos os canais, escutando em 127.0.0.1:18790 por padrão
