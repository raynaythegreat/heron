...
Heron supports LINE through the LINE Messaging API with webhook callbacks.
...
3. Configure the webhook:
   ...
   - Heron uses a shared Gateway HTTP server to receive webhook callbacks for all channels, listening on 127.0.0.1:18790 by default
