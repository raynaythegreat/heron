...
Heron hỗ trợ QQ thông qua API Bot chính thức của Nền tảng Mở QQ.
...
3. Điền thông tin xác thực vào file cấu hình Heron
4. Chạy `heron gateway` để khởi động dịch vụ
...
4. Điền thông tin xác thực vào file cấu hình Heron
5. Chạy `heron gateway` để khởi động dịch vụ
