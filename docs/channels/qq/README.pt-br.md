...
O Heron oferece suporte ao QQ via API Bot oficial da Plataforma Aberta QQ.
...
3. Preencha as credenciais no arquivo de configuração do Heron
4. Execute `heron gateway` para iniciar o serviço
...
4. Preencha as credenciais no arquivo de configuração do Heron
5. Execute `heron gateway` para iniciar o serviço
