...
Heron provides QQ support via the official Bot API from the QQ Open Platform.
...
3. Fill in the credentials in the Heron configuration file
4. Run `heron gateway` to start the service
...
4. Fill in the credentials in the Heron configuration file
5. Run `heron gateway` to start the service
