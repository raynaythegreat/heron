...
Heron は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. Heron 設定ファイルに認証情報を入力する
4. `heron gateway` を実行してサービスを起動する
...
4. Heron 設定ファイルに認証情報を入力する
5. `heron gateway` を実行してサービスを起動する
