...
Heron prend en charge QQ via l'API Bot officielle de la plateforme ouverte QQ.
...
3. Renseigner les identifiants dans le fichier de configuration Heron
4. Exécuter `heron gateway` pour démarrer le service
...
4. Renseigner les identifiants dans le fichier de configuration Heron
5. Exécuter `heron gateway` pour démarrer le service
