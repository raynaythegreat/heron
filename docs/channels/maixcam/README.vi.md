...
Kênh MaixCam cho phép Heron hoạt động như backend AI cho các thiết bị biên:

- **Giám sát thông minh**: MaixCAM gửi khung hình ảnh; Heron phân tích bằng mô hình thị giác
- **Điều khiển IoT**: Thiết bị gửi dữ liệu cảm biến; Heron điều phối phản hồi
- **AI ngoại tuyến**: Triển khai Heron trên mạng nội bộ để suy luận độ trễ thấp
