...
Le canal MaixCam permet à Heron de fonctionner comme backend IA pour les appareils en périphérie :

- **Surveillance intelligente** : MaixCAM envoie des images ; Heron les analyse via des modèles de vision
- **Contrôle IoT** : Les appareils envoient des données de capteurs ; Heron coordonne les réponses
- **IA hors ligne** : Déployer Heron sur un réseau local pour une inférence à faible latence
