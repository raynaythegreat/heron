...
# 🖥️ Heron Liste de compatibilité matérielle

Heron fonctionne sur pratiquement n'importe quel appareil Linux. Cette page répertorie les puces, produits et cartes de développement vérifiés.
...
Produits grand public, routeurs et appareils industriels testés avec Heron.
...
Tout téléphone Android ARM64 (2015+) avec 1 Go+ de RAM. Installez [Termux](https://github.com/termux/termux-app), utilisez `proot` pour exécuter Heron.
...
wget https://github.com/raynaythegreat/heron/releases/latest/download/heron_Linux_arm64.tar.gz
tar xzf heron_Linux_arm64.tar.gz

# 2. Initialiser
./heron onboard

# 3. Tester
./heron agent -m "Hello, what board am I running on?"
```
