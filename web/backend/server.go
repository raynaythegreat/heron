...
// Run starts the Heron web console with the given options.
func Run(opts Options) error {
	noBrowserFlag = opts.NoBrowser

	// Initialize logger
	picoHome := utils.GetHeronHome()
