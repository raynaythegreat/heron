...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open Heron console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About Heron",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit Heron",
		Exiting:            "Exiting Heron...",
		DocUrl:             "https://docs.heron.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 Heron 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 Heron",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 Heron",
		Exiting:            "正在退出 Heron...",
		DocUrl:             "https://docs.heron.io/zh-Hans/docs/",
	},
}
