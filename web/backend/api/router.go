...
type Handler struct {
	...
	memoryStore          *progressive.ProgressiveMemoryStore
	memoryStoreOnce      sync.Once
	hookManager          *hooks.HookManager
	hookManagerOnce      sync.Once
	coordinator          *coordination.Coordinator
	coordinatorOnce      sync.Once
	graphEngine          *graphrag.GraphRAGEngine
	graphEngineOnce      sync.Once
	instinctStore        *learning.InstinctStore
	instinctStoreOnce    sync.Once
}
...
func (h *Handler) RegisterRoutes(mux *http.ServeMux) {
	...
	h.registerCoordinationRoutes(mux)
	h.registerGraphRAGRoutes(mux)
	h.registerInstinctRoutes(mux)
