...
export function ChatEmptyState({
  ...
  return (
    <div className="animate-in fade-in zoom-in-95 duration-500 flex h-full flex-col items-center justify-center px-4">
      <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-2xl bg-cyan-500/10 transition-all duration-500 hover:scale-105 hover:bg-cyan-500/15">
        <img src="/favicon.svg" alt="Heron" className="h-14 w-14" />
      </div>
