    ...
    <div className={cn("flex w-full flex-col gap-1.5", className)}>
      ...
      <div className="bg-card inline-flex w-fit max-w-xs flex-col gap-3 rounded-xl border px-5 py-4">
        ...
        <div className="flex items-center gap-1.5">
          <span className="size-2 animate-bounce rounded-full bg-cyan-400/70 [animation-delay:-0.3s]" />
          <span className="size-2 animate-bounce rounded-full bg-cyan-400/70 [animation-delay:-0.15s]" />
          <span className="size-2 animate-bounce rounded-full bg-cyan-400/70" />
        </div>

        {/* Progress bar */}
        <div className="bg-muted relative h-1 w-36 overflow-hidden rounded-full">
          <div className="absolute inset-0 animate-[shimmer_2s_infinite] rounded-full bg-gradient-to-r from-cyan-500/60 via-cyan-400/80 to-cyan-500/60 bg-[length:200%_100%]" />
        </div>
