import { IconArrowUp, IconBrain, IconGlobe, IconHammer, IconMessageCircle, IconPaperclip, IconPhoto } from "@tabler/icons-react"
...
export function ChatComposer({
  ...
  return (
    <div className="glass shrink-0 px-4 pt-3 pb-[calc(1rem+env(safe-area-inset-bottom))] md:px-6 md:pb-6 lg:px-10 xl:px-16">
          ...
          <div className="bg-card border-border/80 mb-1 overflow-hidden rounded-xl border shadow-lg">
            <ul ref={listRef} className="max-h-64 overflow-y-auto py-1" role="listbox">
              {suggestions.map((cmd, i) => (
                ...
                >
                  <span className="font-mono text-cyan-400 shrink-0">{cmd.usage}</span>
          ...
          <div className="mt-2 flex items-center justify-between px-1">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className={cn(
                  ...
                  chatMode === "chat" && "bg-cyan-500/15 text-cyan-400 hover:bg-cyan-500/20",
            ...
            <div className="flex items-center gap-1">
              ...
              <Button
                ...
                size="icon"
                variant="ghost"
                className="size-8 rounded-full text-muted-foreground hover:text-cyan-400 hover:bg-cyan-500/10"
