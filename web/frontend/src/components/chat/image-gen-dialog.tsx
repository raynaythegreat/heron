        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <IconPhoto className="size-5 text-cyan-400" />
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className={cn(
                ...
                "placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-cyan-500/40",
              )}
              onKeyDown={(e) => {
          ...
          <div className="mb-4 flex flex-wrap gap-3">
            ...
            <div className="flex-1 min-w-[140px]">
              ...
              <select
                ...
                className="w-full rounded-lg border border-border/80 bg-muted/40 px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40"
              >
                {SIZES.map((s) => (
          ...
          {isLoading && (
            <div className="mb-4 flex h-32 items-center justify-center rounded-xl border border-border/80 bg-muted/20">
              <IconLoader2 className="size-6 animate-spin text-cyan-400" />
            </div>
          )}
