                        ...
                        return (
                          <Card
                            ...
                            className={cn(
                              ...
                              tool.status === "enabled" &&
                                "border-cyan-300/60 bg-cyan-50/50 dark:border-cyan-700/40 dark:bg-cyan-950/30",
                              tool.status === "blocked" &&
  ...
  return (
    <span
      className={cn(
        ...
        status === "enabled" && "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300",
