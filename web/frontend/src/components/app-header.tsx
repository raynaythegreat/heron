...
export function AppHeader() {
  ...
  return (
    <header className="glass-header sticky top-0 z-50 flex h-14 shrink-0 items-center justify-between px-4">
      ...
      <div className="text-muted-foreground flex items-center gap-1 text-sm font-medium md:gap-2">
        ...
        <Button variant="ghost" size="icon" className="size-8" asChild>
          <a href="https://github.com/raynaythegreat/Heron" target="_blank" rel="noreferrer">
