const LAST_SESSION_STORAGE_KEY = "heron:last-session-id"
const SHOW_DETAILED_STEPS_STORAGE_KEY = "heron:show-detailed-steps"
const THINKING_LEVEL_STORAGE_KEY = "heron:thinking-level"
