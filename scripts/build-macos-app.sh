#!/bin/bash
# Build macOS .app bundle for Heron Launcher
...
APP_NAME="Heron Launcher"
APP_PATH="./build/${APP_NAME}.app"
APP_CONTENTS="${APP_PATH}/Contents"
APP_MACOS="${APP_CONTENTS}/MacOS"
APP_RESOURCES="${APP_CONTENTS}/Resources"
APP_EXECUTABLE="heron-launcher"
...
if [ -f "./build/heron" ]; then
    cp "./build/heron" "${APP_MACOS}/"
else
    echo "Error: ./build/heron not found. Please build the main file first."
    echo "Run: make build"
    exit 1
fi
chmod +x "${APP_MACOS}/"*
...
<dict>
    ...
    <string>heron-launcher</string>
    <key>CFBundleIdentifier</key>
    <string>com.heron.launcher</string>
