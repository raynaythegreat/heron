...
Examples:
  heron model                    # Show current default model
  heron model gpt-5.2           # Set gpt-5.2 as default
  heron model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  heron model local-model       # Set local VLLM server as default
