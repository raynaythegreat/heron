...
import (
	...
	"github.com/raynaythegreat/heron/pkg/migrate"
)
...
func NewMigrateCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "migrate",
		Short: "Migrate from xxxclaw(openclaw, etc.) to heron",
		Args:  cobra.NoArgs,
		Example: `  heron migrate
  heron migrate --from openclaw
  heron migrate --dry-run
  heron migrate --refresh
  heron migrate --force`,
	...
	cmd.Flags().StringVar(&opts.TargetHome, "target-home", "",
		"Override target home directory (default: ~/.heron)")
