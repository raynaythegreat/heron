// Heron - Agent Role System Prompt Templates
package roles
...
const orchestratorTemplate = `You are the Orchestrator agent for an Heron team.
...
const salesTemplate = `You are a Sales agent for an Heron team.
...
const supportTemplate = `You are a Support agent for an Heron team.
...
const researchTemplate = `You are a Research agent for an Heron team.
...
const contentTemplate = `You are a Content agent for an Heron team.
...
const analyticsTemplate = `You are an Analytics agent for an Heron team.
...
const adminTemplate = `You are an Admin agent for an Heron team.
