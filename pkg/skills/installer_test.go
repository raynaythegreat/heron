...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			repo:         "https://github.com/raynaythegreat/heron/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "heron",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/raynaythegreat/heron/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "heron",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/raynaythegreat/heron",
			wantOwner:    "sipeed",
			wantRepoName: "heron",
			wantRef:      "main",
			wantSubPath:  "",
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "heron")
	...
	err = installer.InstallFromGitHub(context.Background(), "sipeed/heron")
	if err == nil {
