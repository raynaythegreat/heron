# AI Business HQ Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/heron/internal/gateway/`
...
import (
    "github.com/raynaythegreat/heron/pkg/bus"
    "github.com/raynaythegreat/heron/pkg/channels"     // Reference parent package
    "github.com/raynaythegreat/heron/pkg/config"
    "github.com/raynaythegreat/heron/pkg/identity"      // New
    "github.com/raynaythegreat/heron/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/heron/internal/gateway/helpers.go
import (
    _ "github.com/raynaythegreat/heron/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/raynaythegreat/heron/pkg/channels/discord"
    _ "github.com/raynaythegreat/heron/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/raynaythegreat/heron/pkg/channels"
    "github.com/raynaythegreat/heron/pkg/config"
    "github.com/raynaythegreat/heron/pkg/identity"
...
// cmd/heron/internal/gateway/helpers.go
import (
    _ "github.com/raynaythegreat/heron/pkg/channels/matrix"
)
```
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom AI Business HQ native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
