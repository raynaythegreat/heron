# AI Business HQ Channel System：完整开发指南

> **影响范围**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/heron/internal/gateway/`
...
import (
    "github.com/raynaythegreat/heron/pkg/bus"
    "github.com/raynaythegreat/heron/pkg/channels"     // 引用父包
    "github.com/raynaythegreat/heron/pkg/config"
    "github.com/raynaythegreat/heron/pkg/identity"      // 新增
    "github.com/raynaythegreat/heron/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/raynaythegreat/heron/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/raynaythegreat/heron/pkg/channels/discord"
    _ "github.com/raynaythegreat/heron/pkg/channels/your_new_channel"  // 新增
)
```
...
4. **Pico Protocol**：`pkg/channels/pico/` 实现了一个自定义的 AI Business HQ 原生协议 channel，通过 WebSocket webhook (`/pico/ws`) 接收消息。
