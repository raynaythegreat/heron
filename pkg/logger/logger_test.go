...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/heron_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("HERON_LOG_FILE", tmpFile)
	defer os.Unsetenv("HERON_LOG_FILE")
	...
	os.Setenv("HERON_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
