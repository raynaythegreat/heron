...
const (
	...
	userAgentHonest = "heron/%s (+https://github.com/raynaythegreat/heron; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(ctx context.Context, query string, count int) (string, error) {
	...
	// Format results in standard Heron format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies heron, which some
