...
type agentDefaultsV0 struct {
	...
	ModelName                 string         `json:"model_name,omitempty"            env:"HERON_AGENTS_DEFAULTS_MODEL_NAME"`
	Model                     string         `json:"model"                           env:"HERON_AGENTS_DEFAULTS_MODEL"` // Deprecated: use model_name instead
...
type channelsConfigV0 struct {
	...
	WeCom    wecomConfigV0    `json:"wecom"    envPrefix:"HERON_CHANNELS_WECOM_"`
...
type qqConfigV0 struct {
	...
	AppSecret            string              `json:"app_secret"               env:"HERON_CHANNELS_QQ_APP_SECRET"`
...
type telegramConfigV0 struct {
	...
	Token              string              `json:"token"                   env:"HERON_CHANNELS_TELEGRAM_TOKEN"`
...
type feishuConfigV0 struct {
	...
	AppSecret           string              `json:"app_secret"              env:"HERON_CHANNELS_FEISHU_APP_SECRET"`
	EncryptKey          string              `json:"encrypt_key"             env:"HERON_CHANNELS_FEISHU_ENCRYPT_KEY"`
	VerificationToken   string              `json:"verification_token"      env:"HERON_CHANNELS_FEISHU_VERIFICATION_TOKEN"`
...
type discordConfigV0 struct {
	...
	Token              string              `json:"token"                   env:"HERON_CHANNELS_DISCORD_TOKEN"`
...
type dingtalkConfigV0 struct {
	...
	ClientSecret       string              `json:"client_secret"           env:"HERON_CHANNELS_DINGTALK_CLIENT_SECRET"`
...
type slackConfigV0 struct {
	...
	BotToken           string              `json:"bot_token"               env:"HERON_CHANNELS_SLACK_BOT_TOKEN"`
	AppToken           string              `json:"app_token"               env:"HERON_CHANNELS_SLACK_APP_TOKEN"`
...
type matrixConfigV0 struct {
	...
	AccessToken        string              `json:"access_token"             env:"HERON_CHANNELS_MATRIX_ACCESS_TOKEN"`
...
type lineConfigV0 struct {
	...
	ChannelSecret      string              `json:"channel_secret"          env:"HERON_CHANNELS_LINE_CHANNEL_SECRET"`
	ChannelAccessToken string              `json:"channel_access_token"    env:"HERON_CHANNELS_LINE_CHANNEL_ACCESS_TOKEN"`
...
type onebotConfigV0 struct {
	...
	AccessToken        string              `json:"access_token"            env:"HERON_CHANNELS_ONEBOT_ACCESS_TOKEN"`
...
type weixinConfigV0 struct {
	...
	Token              string              `json:"token"                env:"HERON_CHANNELS_WEIXIN_TOKEN"`
...
type picoConfigV0 struct {
	...
	Token           string              `json:"token"                       env:"HERON_CHANNELS_PICO_TOKEN"`
...
type ircConfigV0 struct {
	...
	Password           string              `json:"password"                env:"HERON_CHANNELS_IRC_PASSWORD"`
	NickServPassword   string              `json:"nickserv_password"       env:"HERON_CHANNELS_IRC_NICKSERV_PASSWORD"`
	SASLUser           string              `json:"sasl_user"               env:"HERON_CHANNELS_IRC_SASL_USER"`
	SASLPassword       string              `json:"sasl_password"           env:"HERON_CHANNELS_IRC_SASL_PASSWORD"`
...
type providerConfigV0 struct {
	APIKey         string `json:"api_key"                   env:"HERON_PROVIDERS_{{.Name}}_API_KEY"`
	APIBase        string `json:"api_base"                  env:"HERON_PROVIDERS_{{.Name}}_API_BASE"`
	Proxy          string `json:"proxy,omitempty"           env:"HERON_PROVIDERS_{{.Name}}_PROXY"`
	RequestTimeout int    `json:"request_timeout,omitempty" env:"HERON_PROVIDERS_{{.Name}}_REQUEST_TIMEOUT"`
	AuthMethod     string `json:"auth_method,omitempty"     env:"HERON_PROVIDERS_{{.Name}}_AUTH_METHOD"`
	ConnectMode    string `json:"connect_mode,omitempty"    env:"HERON_PROVIDERS_{{.Name}}_CONNECT_MODE"` // only for Github Copilot, `stdio` or `grpc`
}
...
type openAIProviderConfigV0 struct {
	providerConfigV0
	WebSearch bool `json:"web_search" env:"HERON_PROVIDERS_OPENAI_WEB_SEARCH"`
}
...
type braveConfigV0 struct {
	...
	APIKey     string   `json:"api_key"     env:"HERON_TOOLS_WEB_BRAVE_API_KEY"`
	APIKeys    []string `json:"api_keys"    env:"HERON_TOOLS_WEB_BRAVE_API_KEYS"`
...
type tavilyConfigV0 struct {
	...
	APIKey     string   `json:"api_key"     env:"HERON_TOOLS_WEB_TAVILY_API_KEY"`
	APIKeys    []string `json:"api_keys"    env:"HERON_TOOLS_WEB_TAVILY_API_KEYS"`
...
type perplexityConfigV0 struct {
	...
	APIKey     string   `json:"api_key"     env:"HERON_TOOLS_WEB_PERPLEXITY_API_KEY"`
	APIKeys    []string `json:"api_keys"    env:"HERON_TOOLS_WEB_PERPLEXITY_API_KEYS"`
...
type glmSearchConfigV0 struct {
	...
	APIKey       string `json:"api_key"       env:"HERON_TOOLS_WEB_GLM_API_KEY"`
...
type baiduSearchConfigV0 struct {
	...
	APIKey     string `json:"api_key"     env:"HERON_TOOLS_WEB_BAIDU_API_KEY"`
...
type clawHubRegistryConfigV0 struct {
	...
	AuthToken  string `json:"auth_token"  env:"HERON_SKILLS_REGISTRIES_CLAWHUB_AUTH_TOKEN"`
...
type skillsGithubConfigV0 struct {
	Token string `json:"token"           env:"HERON_TOOLS_SKILLS_GITHUB_TOKEN"`
