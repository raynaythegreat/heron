...
Edit ~/.heron/.security.yml and replace placeholders with your actual keys.

## Step 4: Simplify config.json (Recommended)
Remove sensitive fields from ~/.heron/config.json:
...
export HERON_CHANNELS_DISCORD_TOKEN="discord-token-from-env"

# Web Tools
export HERON_TOOLS_WEB_BRAVE_API_KEY="brave-key-from-env"
export HERON_TOOLS_WEB_BAIDU_API_KEY="baidu-key-from-env"

# Skills
export HERON_TOOLS_SKILLS_GITHUB_TOKEN="github-token-from-env"
```
