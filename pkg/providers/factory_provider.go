...
import (
	...
	anthropicmessages "github.com/raynaythegreat/heron/pkg/providers/anthropic_messages"
	"github.com/raynaythegreat/heron/pkg/providers/azure"
	"github.com/raynaythegreat/heron/pkg/providers/bedrock"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: heron auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: heron auth login --provider openai")
	}
