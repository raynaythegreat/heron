...
import (
	...
	anthropicprovider "github.com/raynaythegreat/heron/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: heron auth login --provider anthropic")
		}
