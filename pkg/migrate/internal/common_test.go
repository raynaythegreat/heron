...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.heron")
	assert.Equal(t, "/home/user/.heron/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.heron/workspace/file.txt", "/home/user/.heron")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".heron"), result)
}
